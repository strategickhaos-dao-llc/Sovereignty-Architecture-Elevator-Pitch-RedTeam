...
import { HebrewLayer, EnglishLayerExtract } from '../types';

export class HebrewLayerProcessor {
  private rootMappings: Record<string, Record<string, string>> = {
    orientation: {
   ...
   */
  process(extract: EnglishLayerExtract): HebrewLayer {
   ...
   */
  private mapToRoots(extract: EnglishLayerExtract): Record<string, string> {
   ...
   */
  private compress(mapping: Record<string, string>): string {
