...
export async function registerCommands(token, appId) {
    const cmds = [
        ...
        new SlashCommandBuilder().setName("set-style").setDescription("Configure your cognitive style preferences")
            ...
            .addChoices({ name: "minimal", value: "low" }, { name: "standard", value: "medium" }, { name: "high", value: "high" }, { name: "extreme", value: "extreme" }))
...
export function cognitiveEmbed(title, description, fields) {
