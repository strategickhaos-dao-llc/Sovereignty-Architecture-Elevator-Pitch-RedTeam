...
export async function registerCommands(token, appId) {
    const cmds = [
        ...
        new SlashCommandBuilder().setName("quantum").setDescription("Quantum core operations")
            .addStringOption(o => o.setName("action").setRequired(true).addChoices({ name: "status", value: "status" }, { name: "fidelity", value: "fidelity" }, { name: "circuits", value: "circuits" }, { name: "resonance", value: "resonance" })),
        // Layer 2: Agent Swarm
        new SlashCommandBuilder().setName("agents").setDescription("AI agent swarm operations")
            .addStringOption(o => o.setName("action").setRequired(true).addChoices({ name: "count", value: "count" }, { name: "health", value: "health" }, { name: "dreams", value: "dreams" }, { name: "wisdom", value: "wisdom" })),
        // Layer 3: Alexander Institute
        new SlashCommandBuilder().setName("institute").setDescription("Alexander Institute operations")
            .addStringOption(o => o.setName("action").setRequired(true).addChoices({ name: "join", value: "join" }, { name: "bounty", value: "bounty" }, { name: "breakthroughs", value: "breakthroughs" }, { name: "gratitude", value: "gratitude" })),
        // Layer 4: White-Web
        new SlashCommandBuilder().setName("whiteweb").setDescription("Sovereign internet operations")
            .addStringOption(o => o.setName("action").setRequired(true).addChoices({ name: "status", value: "status" }, { name: "nodes", value: "nodes" }, { name: "security", value: "security" }, { name: "traffic", value: "traffic" })),
        // Layer 5: Mirror-Generals
        new SlashCommandBuilder().setName("generals").setDescription("Mirror-Generals Council")
            .addStringOption(o => o.setName("action").setRequired(true).addChoices({ name: "wisdom", value: "wisdom" }, { name: "council", value: "council" }, { name: "ask", value: "ask" }))
            .addStringOption(o => o.setName("general").setRequired(false).addChoices({ name: "Tesla", value: "tesla" }, { name: "da Vinci", value: "davinci" }, { name: "Ramanujan", value: "ramanujan" }, { name: "Jung", value: "jung" }, { name: "Thoth", value: "thoth" }))
        ...
        new SlashCommandBuilder().setName("frequency").setDescription("Neurospice frequency engine")
            .addStringOption(o => o.setName("action").setRequired(true).addChoices({ name: "heal", value: "heal" }, { name: "meditate", value: "meditate" }, { name: "flow", value: "flow" }, { name: "stream", value: "stream" })),
        // Layer 7: Origin Node
        new SlashCommandBuilder().setName("origin").setDescription("Origin Node Zero (DOM_010101)")
            .addStringOption(o => o.setName("action").setRequired(true).addChoices({ name: "status", value: "status" }, { name: "align", value: "align" }, { name: "love", value: "love" })),
