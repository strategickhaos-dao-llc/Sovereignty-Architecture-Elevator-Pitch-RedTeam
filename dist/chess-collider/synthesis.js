...
export class ResearchSynthesizer {
    ...
    // SECTION GENERATION
    // =============================================================================
    async generateSections(groupedFindings, params) {
        const sections = [];
    ...
    async generateIntroduction(groupedFindings) {
    ...
    async generateBackground(groupedFindings) {
        try {
    ...
    async generateMethodology(groupedFindings) {
    ...
    async generateDiscussion(groupedFindings) {
        try {
            const findings = Array.from(groupedFindings.values()).flat();
    ...
    async generateConclusion(groupedFindings) {
        const totalFindings = Array.from(groupedFindings.values()).flat().length;
    ...
    // METADATA GENERATION
    // =============================================================================
    async generateMetadata(findings, sections) {
    ...
    async generateAbstract(sections) {
    ...
    // OUTPUT FORMATTING
    // =============================================================================
    formatOutput(sections, metadata, format) {
        switch (format) {
            case 'markdown':
    ...
    formatMarkdown(sections, metadata) {
    ...
    formatUSPTOXml(sections, metadata) {
...
<us-patent-application>
  ...
  <description>
    ...
    getCitationsForSection(groupedFindings, categories) {
        const citations = [];
