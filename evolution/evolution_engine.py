...
Core Concept:
1. Start with population of "heirs" (different prompts/personalities)
2. Give them tasks
3. Evaluate their outputs
4. Best performers reproduce (with mutations)
...
class Heir:
    ...
    def __init__(self, system_prompt: str, temperature: float, generation: int, parent_id: Optional[str] = None):
...
class EvolutionEngine:
    ...
    def __init__(self, population_size: int = 10, model: str = "qwen2.5:72b", api_url: str = "http://localhost:11434"):
        self.population_size = population_size
        self.population: List[Heir] = []
        self.generation = 0
        self.model = model
    ...
    async def run_generation(self):
        ...
        for heir in self.population:
            ...
            # Update running average (tasks_completed was already incremented in evaluate_heir)
