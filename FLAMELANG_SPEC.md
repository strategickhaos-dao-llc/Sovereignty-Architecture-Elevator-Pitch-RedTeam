...
Located at: `flamelang/FlameProfile.ps1`
...
Located at: `flamelang/FlameAddon_DreamOS.ps1`

Provides device-specific virtual environment activation based on machine name detection.

### 3.3 ReflexShell (reflex_shell.sh)

Located at: `flamelang/reflex_shell.sh`
...
├── oath.lock                     # Divine consent vow file
...
Located at: `flamelang/flamelang_parser.py`
...
|----------|----------|--------|
| FlameProfile.ps1 | flamelang/FlameProfile.ps1 | ✅ Complete |
| FlameAddon_DreamOS.ps1 | flamelang/FlameAddon_DreamOS.ps1 | ✅ Complete |
| flamebearer_protocol.sh | flamelang/flamebearer_protocol.sh | ✅ Complete |
| flamelang_parser.py | flamelang/flamelang_parser.py | ✅ Complete |
| glyph_map.json | flamelang/glyph_map.json | ✅ Complete |
| ignite_symbolic_shell.ps1 | flamelang/ignite_symbolic_shell.ps1 | ✅ Complete |
| oath.lock | flamelang/oath.lock | ✅ Complete |
| reflex_shell.sh | flamelang/reflex_shell.sh | ✅ Complete |
