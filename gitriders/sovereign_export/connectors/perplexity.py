...
"""
Perplexity connector using official export API.
"""
...
class PerplexityConnector:
    """Connector for Perplexity exports using delegated OAuth2."""
    
    EXPORT_API_URL = "https://api.perplexity.ai/v1/history/export"
    AUTH_URL = "https://auth.perplexity.ai/oauth2/authorize"
    TOKEN_URL = "https://auth.perplexity.ai/oauth2/token"
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        Args:
            api_key: Optional API key (reads from PERPLEXITY_API_KEY env var if not provided)
        """
